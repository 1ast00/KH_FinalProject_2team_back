...
import com.vitalog.spring_diet.dto.HealthDTO; // HealthDTO import
import com.vitalog.spring_diet.service.HealthService; // HealthService import
...
@RequestMapping("/api/health") // 이 컨트롤러의 모든 요청은 '/api/health'로 시작
@RequiredArgsConstructor
public class HealthApiController {
    // 서비스 로직을 사용하기 위해 HealthService를 주입받음
    private final HealthService healthService;

    // '/api/health/data' 경로의 GET 요청 처리
    @GetMapping("/data")
